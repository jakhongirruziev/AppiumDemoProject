...
import { Colors, signInUrl, verifyUrl } from '../../constants';
...
export function LoginScreen({ navigation }: LoginScreenProps) {
  ...
  return (
    <SafeAreaView style={styles.wrapper}>
            ...
            <TouchableOpacity onPress={() => navigation.navigate('SignUp')}>
              <Text
                style={StyleSheet.flatten([
                  styles.call,
                  { color: Colors.blue, marginTop: 50, textAlign: 'center' },
                ])}
              >
                Register
              </Text>
      ...
      <Button
        label={verifying ? L.login_screen.verify : L.login_screen.sign_in}
        color={
